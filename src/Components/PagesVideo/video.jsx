...
function video() {
  return (
    <div className='w-full h-screen flex items-center justify-center relative max-sm:h-[60vh]'>
        ...
        <video className='z-20 w-[48%] h-[60vh] object-cover max-[992px]:w-[77%] max-md:w-[73%] max-md:h-[30vh] max-sm:w-[74%] max-sm:h-[35vh]' loop muted autoPlay='true' src='https://video.wixstatic.com/video/f1c650_ec0546cb7b10485c8753983f298c6ea4/360p/mp4/file.mp4'></video>
